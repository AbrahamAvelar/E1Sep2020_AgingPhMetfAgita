...
%   DSCATTER(...,'LOGX',true) uses a log scale for the Xaxis. %JAAR
%   20200929
%   Examples:
%
...
if nargin > 2
    ...
    okargs = {'smoothing','bins','plottype','logy','marker','msize','filled','logx'};%JAAR 20200929
    for j=1:2:nargin-2
        pname = varargin{j};
        pval = varargin{j+1};
